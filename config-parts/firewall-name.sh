...
set firewall name iot-servers rule 410 description 'Rule: accept_k8s_ingress_from_allowed_devices'
...
set firewall name iot-servers rule 410 source group address-group 'k8s_ingress_allowed'
