...
set nat destination rule 102 inbound-interface name 'eth1.40'
...
set nat destination rule 103 inbound-interface name 'eth1.50'
...
set nat destination rule 105 inbound-interface name 'eth1.10'
...
set nat destination rule 106 inbound-interface name 'eth1.20'
...
set nat destination rule 107 inbound-interface name 'eth1.40'
...
set nat destination rule 108 inbound-interface name 'eth1.50'
