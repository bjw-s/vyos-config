...
set firewall ipv4 name iot-local rule 200 destination port '1900,1901,1902'
...
set firewall ipv4 name local-iot rule 200 destination port '1900,1901,1902,57621'
...
set firewall ipv4 name local-trusted rule 200 destination port '1900,1901,1902'
...
set firewall ipv4 name trusted-local rule 210 destination port '1900,1901,1902,57621'
